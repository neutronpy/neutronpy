...
# -*- coding: utf-8 -*-
#
# neutronpy documentation build configuration file, created by
...
latex_documents = [
  ('index', 'neutronpy.tex', 'neutronpy Documentation',
   'David M Fobes', 'manual'),
]
...
texinfo_documents = [
  ('index', 'neutronpy', 'neutronpy Documentation',
   'David M Fobes', 'neutronpy', 'One line description of project.',
   'Miscellaneous'),
]
